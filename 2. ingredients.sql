...
(select * from atc_drug_scraper where atc_code in (select atc_code from atc_drug_scraper where adm_r = 'TD'))
...
delete from drug_concept_stage where concept_code in (
select concept_code from
(select * from atc_drug_scraper d1 where atc_code in (select atc_code from atc_drug_scraper where adm_r = 'SL') and not exists (select 1 from atc_drug_scraper d
